        ...
        Container(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text('Welcome Back'),
                    SizedBox(height: 7,),
                    Text('Aly',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
          ...
          Center(
            child: MaterialButton(
              ...
              onPressed: (){Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>BlocProvider(
